...
dream-ui is a multi-process Electron app with three core layers: **renderer**, **main process**, and **preload/shared**.
...
├── base/           # UI primitives — DreamModal, DreamSelect, FlexFullContainer, etc.
