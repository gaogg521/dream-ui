...
- **仓库更名对照（dream-ui→1oneUI）**? [`guides/repo-rename-2026-07-08.zh-CN.md`](guides/repo-rename-2026-07-08.zh-CN.md).
...
- **2026-07-13：PDF 导出 Agent 不选用 export_to_pdf（dream-engine ToolSearch 误判）+ 团队成员 Provider 'dream-engine' not found（model="default" 占位符污染）修复，三仓改动索引**? [`guides/session-2026-07-13-toolsearch-team-provider-fixes.zh-CN.md`](guides/session-2026-07-13-toolsearch-team-provider-fixes.zh-CN.md).
...
- **2026-07-15：企业 SSO 桌面 deep link 被 dev/打包版互相抢注根治（`dream-ui://` 改成 dev/prod 各注册各的 scheme，后端 `scheme` 查询参数白名单校验）**? [`guides/session-2026-07-15-sso-deep-link-scheme-collision.zh-CN.md`](guides/session-2026-07-15-sso-deep-link-scheme-collision.zh-CN.md).
...
- **2026-07-19：上游同步（v2.1.37/Core 0.1.48/dream-engine 0.2.5）功能与提交总表**? [`guides/session-2026-07-19-upstream-sync-changelog.zh-CN.md`](guides/session-2026-07-19-upstream-sync-changelog.zh-CN.md)。
