...
> 起因：有人问"MD 文档里还有很多没做吧"。全仓 `- [ ]` 共 **626** 条，分布在 20 个文件。
...
| 文件                                                       | 条数 | 说明                                                                                                                         |
| ---------------------------------------------------------- | ---: | ---------------------------------------------------------------------------------------------------------------------------- |
| `enterprise-team-roadmap.zh-CN.md`                         |   18 | 企业版路线图 P0/P1/P2。P0 五条是"不做就卖不动"级：SAML、SCIM 2.0、OIDC 硬化（JWKS 验签）、席位/license/用量看板、细粒度 RBAC |
...
3. **企业版 P0 那五条**是唯一"不做会挡住卖"的一组，值得单独拉出来排期。
