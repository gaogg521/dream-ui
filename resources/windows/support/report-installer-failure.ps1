...
function New-ReportDetailsText(
  ...
  $lines.Add('--------------------------------')
  $lines.Add('One Work installer failure ' + $code)
  $lines.Add('--------------------------------')
  $lines.Add('')
  if ($eventId) {
...
try {
  ...
  Show-ReportMessage ('One Work installer report sent.' + [Environment]::NewLine + [Environment]::NewLine + 'Tip: To reach the One Work team, press [ Ctrl + C ] in this dialog to copy details, then contact us via our official website:' + [Environment]::NewLine + 'https://1one.1oneclaw.com' + [Environment]::NewLine + [Environment]::NewLine + $reportDetails) 'Information'
} catch {
  ...
  Show-ReportMessage ('One Work installer report failed.' + [Environment]::NewLine + [Environment]::NewLine + 'Status: ' + $statusPath + [Environment]::NewLine + 'Log: ' + $log) 'Exclamation'
}
