...
/**
 * 企业知识库文档导入支持的文件扩展名（无点前缀，供文件选择器 filters 用）。
 * Extraction dispatch lives in `process/utils/documentTextExtraction.ts`
 * (main-process-only, needs Node APIs) — kept in sync with this list.
 */
