 ...
 *   - macOS:   ~/Library/Logs/Dream UI/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\Dream UI\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/Dream UI/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
