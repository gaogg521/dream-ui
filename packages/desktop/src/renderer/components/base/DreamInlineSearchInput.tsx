...
import styles from './DreamInlineSearchInput.module.css';

/**
 * DreamInlineSearchInput —— 下拉列表专用的轻量搜索框
 *
 * 样式基准取自首页 Project 选择下拉曾用的搜索框：浅灰填充、无边框、8px 圆角、
 * 放大镜图标 + 透明输入框，柔和紧凑，适合“点击展开的下拉列表”顶部内嵌使用。
 * 与 DreamSearchInput（34px 描边、focus 主色环，适合常驻搜索栏）区分：
 * 常驻列表用 DreamSearchInput，点击触发展开的下拉列表用本组件。
 *
...
DreamInlineSearchInput.displayName = 'DreamInlineSearchInput';

export default DreamInlineSearchInput;
