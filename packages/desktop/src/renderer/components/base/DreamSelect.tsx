 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <DreamSelect placeholder="请选择" style={{ width: 200 }}>
 *   <DreamSelect.Option value="1">选项1</DreamSelect.Option>
 *   <DreamSelect.Option value="2">选项2</DreamSelect.Option>
 * </DreamSelect>
 *
 * // 多选 / Multiple selection
 * <DreamSelect mode="multiple" placeholder="请选择多个">
 *   <DreamSelect.Option value="1">选项1</DreamSelect.Option>
 *   <DreamSelect.Option value="2">选项2</DreamSelect.Option>
 * </DreamSelect>
 *
 * // 分组 / Grouped options
 * <DreamSelect placeholder="请选择">
 *   <DreamSelect.OptGroup label="分组1">
 *     <DreamSelect.Option value="1">选项1</DreamSelect.Option>
 *   </DreamSelect.OptGroup>
 *   <DreamSelect.OptGroup label="分组2">
 *     <DreamSelect.Option value="2">选项2</DreamSelect.Option>
 *   </DreamSelect.OptGroup>
 * </DreamSelect>
 * ```
...
DreamSelect.Option = Select.Option;
DreamSelect.OptGroup = Select.OptGroup;
