 ...
 * <DreamScrollArea className="h-400px">
 *   <div>Content...</div>
 * </DreamScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <DreamScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </DreamScrollArea>
 *
 * // 双向滚动 / Both directions
 * <DreamScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </DreamScrollArea>
 * ```
 */
...
DreamScrollArea.displayName = 'DreamScrollArea';

export default DreamScrollArea;
