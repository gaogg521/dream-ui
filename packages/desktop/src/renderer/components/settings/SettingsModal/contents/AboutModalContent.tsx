...
import { Divider, Typography, Button, Message } from '@arco-design/web-react';
...
const AboutModalContent: React.FC = () => {
  ...
  const linkItems: LinkItem[] = [
    ...
    },
    {
      ...
      url: ABOUT_OFFICIAL_WEBSITE_URL,
      icon: <Right theme='outline' size='16' className='rtl-mirror' />,
    },
  ];
  ...
  return (
    <div className='flex flex-col h-full w-full'>
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <div className='flex items-center justify-center gap-8px mb-16px'>
              ...
              <div
                ...
                onClick={() =>
                  openLink(ABOUT_GITHUB_REPO_URL).catch((error) => console.error('Failed to open link:', error))
                }
              >
      ...
      <WeChatContactModal visible={showWeChatModal} onCancel={() => setShowWeChatModal(false)} />
    </div>
  );
};
