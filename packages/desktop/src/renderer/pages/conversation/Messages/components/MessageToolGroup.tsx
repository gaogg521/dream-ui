...
const ToolResultDisplay: React.FC<{
  ...
  // Media generated by the built-in media tool is announced as
  // "Generated <kind> saved to: <path>" lines. Render those as real media on
  // top of the text — the text stays because agents and existing prompts read
  // it, the visual layer is additive.
  const mediaAssets = parseGeneratedMediaAssets(display);
  ...
  return (
    <>
      ...
      <GeneratedMediaView assets={mediaAssets} />
    </>
  );
};
