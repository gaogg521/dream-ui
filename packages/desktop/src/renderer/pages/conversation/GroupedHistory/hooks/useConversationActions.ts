...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via DreamModal in the GroupedHistory component.
   * Uses project's design system: DreamModal component with danger-styled action button.
   */
