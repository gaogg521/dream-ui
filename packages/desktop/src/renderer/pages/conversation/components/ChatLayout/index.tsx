...
const ChatLayout: React.FC<{
  ...
  const display_name = presetAssistant?.name || agent_name || brandedBackend || backend;
        ...
        <ChatTitleEditor
          ...
          leading={
            ...
            ((backend || presetAssistant) && (
              // Which assistant/backend this conversation is bound to is otherwise
              // only conveyed by an icon (title is the first message, not the
              // assistant name) — show the name so it's visible without hovering.
              <AgentBadge
                backend={backend}
