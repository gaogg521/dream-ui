                  ...
                  <div
                    className={classNames(
                      ...
                      isIndexMatch(item.index, normalizedKeyword)
                        ? 'text-[rgba(var(--primary-6),1)] font-semibold'
                        : 'text-t-secondary'
                    )}
                  >
                    #{item.index}
        ...
        >
          <IconSearch
            className={classNames(
              ...
              visible
                ? 'scale-103 opacity-100 text-[rgba(var(--primary-6),1)]'
