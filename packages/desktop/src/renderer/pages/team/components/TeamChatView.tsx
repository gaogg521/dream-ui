...
import { useDreamEngineModelSelection } from '@/renderer/pages/conversation/platforms/dreamEngine/useDreamEngineModelSelection';
...
const DreamEngineChat = React.lazy(() => import('@/renderer/pages/conversation/platforms/dreamEngine/DreamEngineChat'));
...
const DreamEngineTeamChat: React.FC<{
  ...
  const modelSelection = useDreamEngineModelSelection({ initialModel: conversation.model, onSelectModel });
    ...
    switch (conversation.type) {
      ...
      case 'dream':
        return (
          <DreamEngineTeamChat
            key={conversation.id}
            conversation={conversation as DreamEngineConversation}
            emptySlot={emptySlot}
