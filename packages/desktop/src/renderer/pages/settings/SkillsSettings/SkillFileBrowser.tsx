...
const SkillFileBrowser: React.FC<SkillFileBrowserProps> = ({ skill }) => {
  ...
  return (
    <div className='h-420px min-h-0 flex overflow-hidden rounded-10px border border-solid border-3 bg-1'>
      ...
      <div className='min-w-0 flex-1 flex flex-col'>
        <div className='h-40px shrink-0 flex items-center gap-8px border-b border-solid border-3 px-10px'>
