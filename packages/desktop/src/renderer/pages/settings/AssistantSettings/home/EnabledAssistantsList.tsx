...
const EnabledAssistantRow: React.FC<EnabledAssistantRowProps> = ({
  ...
  // Fork: marketplace personas carry display_name/role_name, which
  // resolveAssistantName folds in on top of upstream's name_i18n fallback.
  ...
  return (
    <div
      ...
      className='group flex cursor-pointer items-center justify-between gap-12px rounded-12px border border-solid border-2 bg-base px-14px py-12px transition-all duration-180 hover:border-primary-2'
