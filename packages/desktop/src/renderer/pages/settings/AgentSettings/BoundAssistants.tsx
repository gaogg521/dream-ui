...
const assistantLabel = (assistant: Assistant, localeKey: string): string => resolveAssistantName(assistant, localeKey);
 ...
 * the remainder so a high-fan-out engine (e.g. dream) stays readable.
 */
