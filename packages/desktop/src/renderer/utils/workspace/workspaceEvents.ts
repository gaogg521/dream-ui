export const WORKSPACE_TOGGLE_EVENT = 'one-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'one-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'one-workspace-has-files';
