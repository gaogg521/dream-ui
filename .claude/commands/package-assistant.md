# Package OfficeCLI Skill as One Work Assistant

Convert an OfficeCLI skill into a fully wired One Work assistant preset, or update an existing one.
...
> After the file appears in the workspace, you can preview it directly in One Work. However, please do not click "Open with system app" while I'm still working, as this may lock the file and cause the operation to fail.
