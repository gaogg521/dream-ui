...
// DreamModal (pulled into this tree by the upstream About redesign) reads the
// theme context. Mock the hook rather than mounting the real ThemeProvider,
// which fetches /api/settings/client and has no backend under jsdom.
