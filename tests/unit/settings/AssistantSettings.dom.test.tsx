...
vi.mock('@/renderer/hooks/assistant', () => ({
  ...
  // Fork-only: backs the Expert Marketplace tab on this page.
  useMarketplacePersonas: () => ({ personas: [], loading: false, install: vi.fn() }),
}));
...
describe('AssistantSettings', () => {
  ...
  it('disables enabled-assistant dragging while search is active', () => {
    const assistants = [
      { id: 'cli', name: 'Codex', sort_order: 1, source: 'generated', enabled: true, agent_status: 'online' },
