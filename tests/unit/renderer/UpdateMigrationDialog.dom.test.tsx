...
// DreamModal reads ThemeContext for font scaling; provide a minimal theme so it mounts.
...
describe('UpdateMigrationDialog', () => {
  ...
  it('opens the official website when the primary button is clicked', async () => {
    ...
    expect(mocks.openExternalUrl).toHaveBeenCalledWith('https://www.dream.com/');
  });
});
