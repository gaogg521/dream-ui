...
describe('resolveFeedbackModule', () => {
  it.each([
    ...
    // Legacy top-level redirects for Super Assistant / My Skills / Memory —
    // these paths only exist as <Navigate> aliases now, but the mapping still
    // resolves them to the same module their new /settings/* home uses.
