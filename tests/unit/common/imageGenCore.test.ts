...
describe('processImageUri', () => {
  ...
  it.skipIf(!symlinkSupported)('should block a symlink inside the workspace that points outside', async () => {
    const ws = createWorkspace();
  ...
  it.skipIf(!symlinkSupported)('should allow a symlink inside the workspace that stays inside', async () => {
    const ws = createWorkspace();
