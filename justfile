...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  One Work Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
info:
    #!/usr/bin/env bash
    echo "One Work Build Environment"
    echo "========================"
...
build-win: preflight
    ...
    Get-Process -Name "onework","1onecode","AionUI","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
