...
for (const [key, name] of [
  ['a', 'CDP-Delivery-A (dev)'],
  ['b', 'CDP-Delivery-B (dev)'],
]) {
...
if (!aCheck.sessions)
  console.log(
    '[cdp-shot] NOTE: outbound [[DREAM_SESSIONS]] marker not visible in A body text (may render as styled widget)'
  );
