...
for f in One-Work-1.0.0-win-x64.exe One-Work-1.0.0-win-arm64.exe One-Work-1.0.0-mac-x64.dmg One-Work-1.0.0-mac-arm64.dmg One-Work-1.0.0.deb One-Work-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
